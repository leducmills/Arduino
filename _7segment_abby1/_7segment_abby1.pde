...
int flex1 = A5; //Flexsensor1

int sitCount = 0;
//float timer = 0;
boolean sitStart = false;
boolean sitEnd = false;
long lastDebounceTime = 0;
long debounceDelay = 50;
int flexval1;
int address = 0;

//change this to change sensitivity - higher the number, the less sensitive it will be 
int threshold = 50;
...
void loop() {
  ...
  displayNumber(sitCount);

  readSit();

  //Serial.println(flex1val, DEC);
...
int flexval2 = analogRead(flex1);
Serial.print(flexval1);
Serial.print(" ");
Serial.println(flexval2);


  if(flexval2 > flexval1 + threshold) {

    sitStart = true; 

  }

  if (flexval2 < (flexval1 + threshold) && sitStart == true) {

    sitEnd = true;

  }

  if (sitStart == true && sitEnd == true) {

    sitCount++;
    sitStart = false;
    sitEnd = false;
    EEPROM.write(address, sitCount);
